...
//
//	mockgen -source=./internal/repository/article_reader.go -package=articlerepomocks -destination=./internal/repository/mocks/article_reader.mock.go
//
...
import (
	...
	domain "github.com/zht-account/webook/internal/domain"
